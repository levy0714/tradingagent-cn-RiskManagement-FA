    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            "investment_debate_state": {
                ...
                "history": (final_state.get("investment_debate_state") or {}).get("history", ""),
                "current_response": (final_state.get("investment_debate_state") or {}).get("current_response", ""),
                "judge_decision": (final_state.get("investment_debate_state") or {}).get("judge_decision", ""),
            },
            "trader_investment_decision": final_state.get("trader_investment_plan", ""),
            "risk_debate_state": {
                "aggressive_history": (final_state.get("risk_debate_state") or {}).get("aggressive_history", ""),
                "conservative_history": (final_state.get("risk_debate_state") or {}).get("conservative_history", ""),
                "neutral_history": (final_state.get("risk_debate_state") or {}).get("neutral_history", ""),
                "history": (final_state.get("risk_debate_state") or {}).get("history", ""),
                "judge_decision": (final_state.get("risk_debate_state") or {}).get("judge_decision", ""),
            },
