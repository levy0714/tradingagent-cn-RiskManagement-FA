...
class TestTraderAgent:
    ...
    def test_prompt_includes_investment_plan(self):
        ...
        # 架构改造后(研究经理已删除),交易员直接基于分析师报告生成交易方案。
        # The analyst reports are in the user message of the captured prompt.
        prompt = captured["prompt"]
        assert any("Analyst Reports" in m["content"] for m in prompt)
